...
try:
    ...
    #st.write(len(selected_players_df))
    #fetching the total number of players seelction by user from context_sidebar_manual_selection
    ...
    if total_players != 11:
        ...
        <div style="font-size:24px; color:#006d77; font-weight:600; padding:8px 12px;">
            ⚠️ Please make sure the total number of <strong>Batsmen</strong>, <strong>Batting All-rounders</strong>, 
            <strong>Pacers</strong>, <strong>Spinners</strong> and <strong>Bowling All-rounders</strong> adds up to exactly <strong>11</strong>.
        </div>
        """,
        ...
        """
        <div style="font-size:24px; color:#006d77; font-weight:600; padding:8px 12px;">
            Sorry! Based on your current selection or due to limitations in the dataset, we're unable to generate a complete playing XI.
        <br></div>""",
        unsafe_allow_html=True)
